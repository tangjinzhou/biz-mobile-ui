export default {
    ...
    //## White
    white_lighter: 'rgba(255,255,255,.12)',
    white_light: 'rgba(255,255,255,.30)',
    white_dark: 'rgba(255,255,255,.70)',
    white_darker: 'rgba(255,255,255, 1)',
    //'#'# Black
    black_lighter: 'rgba(0,0,0,.12)',
    black_light: 'rgba(0,0,0,.26)',
    black_dark: 'rgba(0,0,0,.54)',
    black_darker: 'rgba(0,0,0,.87)',
};
